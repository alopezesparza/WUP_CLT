...
```
take the standard deviation and put it in the data that is from the cetral limit. The standard deviation shrinks as the number gets higher example 4 is divided by 2, 9 is divided by 3. 16 divided by 4 and so on. 
the standard deviation is sd = 14.1672561441101, the expected value is the standard deviation divided by square root of the sample size. the mean is going to stay the same and the standard deviation is going to shrink. the original standard deviation was 41.7116842215775. we expect 14 and we get `r sd(my1000$k3)`   
...
```
 the standard deviation is now a quarter of what it was before which is now `r sd(my1000$k4)`. 
...
```
the standard deviation should be a fifth of what it originally was, this `r sd(my1000$k5)` and we expected 8 
...
```
 the standard deviation is  `r sd(my1000$k6)`, we expected 6.   
